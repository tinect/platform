...
class CartSerializationCleanerTest extends TestCase
{
     ...
     */
    public function testLineItemCustomFields(Cart $cart, ?array $payloads = null, array $allowed = []): void
    {
    ...
    public function cleanupCustomFieldsProvider()
    {
    ...
    public function cleanupCoversProvider()
    {
    ...
    private static function coverItem(string $id, ?string $thumbnailString, $skipCover = false): LineItem
    {
        $item = new LineItem($id, 'foo');
        $childItem = new LineItem($id . 'child', 'foo');
    ...
    private static function coverCart(string $id, ?string $thumbnailString, $skipCover = false): Cart
    {
